...
$sql = "select *from notice where seq = $see_num";
...
$id = 'admin';
$sql_see_count = "update notice set see_count = see_count + 1 where seq = $see_num";
...
<head>
	...
	<body>
		...
		<hr/>
		<form action="noticeseede.php" method="post">
		...
		<hr class=line/>
		<?php include("notice_comment.php"); ?>
	</body>
</html>