...
if($num==1){
	$sql = "insert into notice_comment(id, detail, seq_num) value('$id','$detail','$seq_re');";
	$result = mysqli_query($conn, $sql);
	...
	if($result===false){
		...
		$num = 0;
?>
<meta http-equiv="refresh" content="0;URL='/see/noticesee.php?seq=<?php echo $seq_re;?>'"><!--
<?php	
	}
}
$sql="select *from notice_comment where seq_num=$seq_num";
$result=mysqli_query($conn,$sql);
?>
<html lang="ko">
<head>
	...
	<link href="/css/noticecss.css" rel="stylesheet" type="text/css">
	...
	<body>
		...
		?>
		<form name="writeform" action="notice_comment.php" method="post" class="comment_input">
			<p>
