...
$sql="select *from documentboard order by seq desc";
...
<body>
		...
		<table>
			...
			<tbody>
				...
				<tr class="row_body">
					...
					<td class="data2"><a href="/see/documentsee.php?seq=<?php echo $row['seq']?>"><?php echo $row['title']; ?></a></td>
	...
	<br>
	<a href="/board/documentwrite.php"><input class="write" type="button" value="글쓰기"></a>
</body>
</html>