...
<body>
		...
		<table>
			...
			<tbody>
				...
				<tr class="row_body">
					...
					<td class="data2"><a href="/see/noticesee.php?seq=<?php echo $row['seq']?>"><?php echo $row['title']; ?></a></td>
					<td class="data3"><?php echo $id ?></td>
	...
	<?php
	if ($au<3 || !isset($au)){ ?>
		<a href="/board/noticewrite.php"><input type="button" value="글쓰기" disabled ></a>
	<?php
	}
	else{ ?>
		<a href="/board/noticewrite.php"><input type="button" value="글쓰기"></a>
	<?php
	}
	?>
</body>
